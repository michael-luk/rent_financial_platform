...
public class InfoController extends Controller implements IConst {
	...
	public static Result report(String startTime, String endTime) {
        ...
        sheet2.setDefaultColumnStyle(9, cellStyle);//description1
        sheet2.setColumnWidth(10, 4000);
        sheet2.setDefaultColumnStyle(10, cellStyle);//description2
		...
		sheet2.addMergedRegion(new Region(0, (short) 0, 0, (short) 11));
        ...
        titleRow.createCell(7).setCellValue(TableInfoReader.getFieldComment(Info.class, "lastUpdateTime"));//last_update_time
        titleRow.createCell(8).setCellValue(TableInfoReader.getFieldComment(Info.class, "createdAt"));//created_at
        titleRow.createCell(9).setCellValue(TableInfoReader.getFieldComment(Info.class, "description1"));//description1
        titleRow.createCell(10).setCellValue(TableInfoReader.getFieldComment(Info.class, "description2"));//description2
        titleRow.createCell(11).setCellValue(TableInfoReader.getFieldComment(Info.class, "comment"));//comment
		...
		for (int i = 0; i < list.size(); i++) {
            ...
            if (item.description1 == null) {
                ...
                cell9.setCellValue(item.description1);
            }
            HSSFCell cell10 = row.createCell(10);
            if (item.description2 == null) {
                cell10.setCellValue("");
            } else {
                cell10.setCellValue(item.description2);
            }
