var app = angular.module('MyHouseContractSubmitApp', ['angularFileUpload']);

app.controller('MyHouseContractSubmitController', [
    '$scope',
    '$upload',
    '$http',
    '$log',
    function ($scope, $upload, $http, $log) {
        ...
        $scope.doBind = function (uid) {
            ...
            $http({
                method: 'POST',
                url: '/my/housecontract/submit',
                data: postItem
            }).success(function (data, status, headers, config) {
                if (data.flag) {
                    location.href = '/p/my/housecontract'
                } else {
